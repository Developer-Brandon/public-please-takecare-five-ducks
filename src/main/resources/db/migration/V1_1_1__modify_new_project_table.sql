...
alter table plz_tc_fd.tb_anime_thumbnail_img add foreign key(r_anime_no)
    references plz_tc_fd.tb_anime (r_anime_no) on delete cascade;
...
alter table plz_tc_fd.tb_anime_view add foreign key(r_anime_no)
    references plz_tc_fd.tb_anime(r_anime_no) on delete cascade;
...
alter table plz_tc_fd.tb_book add r_book_type_no int unsigned comment '책의 종류 번호' after m_n_no;
alter table plz_tc_fd.tb_book add link int unsigned comment '링크' after author;
alter table plz_tc_fd.tb_book modify book_reg_dt datetime not null default current_timestamp comment '출간일자 혹은 컨텐츠 제작일자';
alter table plz_tc_fd.tb_book add mod_dt datetime not null default current_timestamp comment '수정일자' after reg_dt;
...
alter table plz_tc_fd.tb_book_thumbnail_img add foreign key(r_book_no)
    references plz_tc_fd.tb_book (r_book_no) on delete cascade;
...
alter table plz_tc_fd.tb_book_view add foreign key(r_book_no)
    references plz_tc_fd.tb_book(r_book_no) on delete cascade;
...
alter table plz_tc_fd.tb_comic_book_thumbnail_img add foreign key(r_book_no)
    references plz_tc_fd.tb_comic_book (r_book_no) on delete cascade;
...
alter table plz_tc_fd.tb_comic_book_view add foreign key(r_book_no)
    references plz_tc_fd.tb_comic_book(r_book_no) on delete cascade;
...
alter table plz_tc_fd.tb_drama_book_thumbnail_img add foreign key(r_drama_no)
    references plz_tc_fd.tb_drama (r_drama_no) on delete cascade;
...
alter table plz_tc_fd.tb_drama_view add foreign key(r_drama_no)
    references plz_tc_fd.tb_drama(r_drama_no) on delete cascade;
...
alter table plz_tc_fd.tb_movie_thumbnail_img add foreign key(r_movie_no)
    references plz_tc_fd.tb_movie (r_movie_no) on delete cascade;
...
alter table plz_tc_fd.tb_movie_view add foreign key(r_movie_no)
    references plz_tc_fd.tb_movie(r_movie_no) on delete cascade;
...
# 3.컨텐츠 제작 국가 테이블 수정
alter table plz_tc_fd.tb_contents_made_nature add mod_dt datetime not null default current_timestamp comment '수정일자' after reg_dt;
