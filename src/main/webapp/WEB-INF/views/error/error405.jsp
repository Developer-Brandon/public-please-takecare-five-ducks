...
<head>
    ...
    <link rel="stylesheet" href="${pageContext.request.contextPath}/resources/css/error/error405.css">
</head>
            ...
            <div class="error-title-section">
                <div class="input-section__inner">
                    ...
                    <div class="logo-and-wording">
                        ...
                        <h1 class="main-logo-wording">405<br>ERROR</h1>
                        <p class="wording">허용되지 않는 메소드입니다.<br><br><br>
