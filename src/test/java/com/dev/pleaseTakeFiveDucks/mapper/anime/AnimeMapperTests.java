package com.dev.pleaseTakeFiveDucks.mapper.anime;

import com.dev.pleaseTakecareFiveDucks.anime.domain.dto.request.InsertAnimeInfoRequestDTO;
import com.dev.pleaseTakecareFiveDucks.anime.mapper.AnimeMapper;
...
public class AnimeMapperTests {
    ...
    private static final Logger logger = LoggerFactory.getLogger(AnimeMapper.class);
